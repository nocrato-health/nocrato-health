...
<Button className="bg-amber-bright text-amber-dark hover:bg-[#af830d] hover:text-white font-semibold">
  Confirmar
</Button>

// Secondary — blue steel
<Button variant="secondary" className="bg-blue-steel text-white hover:bg-[#5a7290]">
  Cancelar
</Button>

// Outline — warm border
<Button variant="outline" className="border-[#af830d] text-amber-dark hover:bg-[#fef9e6]">
  Editar
</Button>
...
const statusConfig = {
  scheduled: {
    label: "Agendada",
    className: "bg-[#6c85a0]/10 text-[#6c85a0] border-[#6c85a0]/30",
  },
  waiting: {
    label: "Aguardando",
    className: "bg-[#fabe01]/10 text-[#af830d] border-[#fabe01]/30",
  },
  in_progress: {
    label: "Em Atendimento",
    className: "bg-[#de782e]/10 text-[#de782e] border-[#de782e]/30",
  },
  completed: {
    label: "Concluída",
    className: "bg-[#6e5305]/10 text-[#6e5305] border-[#6e5305]/30",
  },
  cancelled: {
    label: "Cancelada",
  ...
  rescheduled: {
    label: "Reagendada",
    className: "bg-[#af830d]/10 text-[#af830d] border-[#af830d]/30",
  },
};
```
...
<Link className="flex items-center gap-3 px-3 py-2 rounded-md
  ...
  data-active:bg-[#fef9e6] data-active:text-amber-dark data-active:border-l-2 data-active:border-amber-bright
  hover:bg-[#fef9e6] hover:text-amber-dark text-muted-foreground">
```
...
<div className="flex items-center justify-between mb-6">
  <div>
    <h1 className="text-2xl font-bold text-amber-dark font-[Montserrat]">
      Pacientes
    </h1>
