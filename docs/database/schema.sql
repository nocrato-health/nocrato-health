...
COMMENT ON TABLE agent_settings IS 'WhatsApp AI agent configuration. 1:1 with tenant. Read by internal agent module (agent.service.ts). Provider: Meta Cloud API (whatsapp_phone_number_id).';
