interface InviteDoctorTemplateParams {
  inviteUrl: string
  invitedByName: string
}

export function inviteDoctorTemplate({ inviteUrl, invitedByName }: InviteDoctorTemplateParams): string {
  return `<!DOCTYPE html>
<html lang="pt-BR">
<head>
  <meta charset="UTF-8" />
        ...
        <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:40px;">
              <h1 style="margin:0 0 16px;font-size:22px;color:#0f172a;">Você foi convidado para o Nocrato Health</h1>
              <p style="margin:0 0 24px;font-size:15px;color:#374151;line-height:1.6;">
                <strong>${invitedByName}</strong> convidou você para criar o seu portal médico no <strong>Nocrato Health</strong>.
                Ao aceitar o convite, você poderá configurar seu consultório digital e gerenciar seus pacientes.
              </p>
